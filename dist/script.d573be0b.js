...
$(function () {
  ...
  setTimeout(function () {
    typeWriter2();
  }, 1900); // Nav Page Transitions within eachother
  ...
  $('#secondary-nav').css('display', 'flex'); // Footer Slide Up

  $('#footer').slideDown('slow');
  $('#footer').css('display', 'block'); // Mobile Version
